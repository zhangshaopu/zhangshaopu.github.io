...
if(arguments[0]==="🌙"){changeUtterancesTheme("photon-dark");}else{changeUtterancesTheme("github-light");}
function changeUtterancesTheme(){const iframe=document.querySelector('.utterances-frame');if(iframe!==null){const message={type:'set-theme',theme:arguments[0]};iframe.contentWindow.postMessage(message,'https://utteranc.es');}}}
function setMode(){window.localStorage.setItem('theme',arguments[0]);};function langSwitcherOver(){document.getElementById("langs").setAttribute("style","display:block");}
